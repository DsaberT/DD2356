...
int main(int argc, char *argv[]){
    ...
    //  Tag 0: From left to right & Tag 1: From right to left
    //

    MPI_Send(&f[2], 1, MPI_DOUBLE, Previous_R, 0, MPI_COMM_WORLD);
    MPI_Recv(&f[nxn_loc-1], 1, MPI_DOUBLE, Next_R, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
    MPI_Send(&f[nxn_loc-3], 1, MPI_DOUBLE, Next_R, 1, MPI_COMM_WORLD);
    MPI_Recv(&f[0], 1, MPI_DOUBLE, Previous_R, 1, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
